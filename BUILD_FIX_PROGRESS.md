...
| 序号 | 改进项 | 文件 | 复杂度 |
|------|--------|------|--------|
| 3.1 | 字体大小增减按钮 | `EditorView.java` | 低 |
| 3.2 | 工具栏显示文件路径 | `EditActivity.java` | 低 |
| 3.3 | 自动换行默认启用 | `CodeEditText.java` | 低 |

### 第四阶段：架构改进 (可选)
| 序号 | 改进项 | 文件 | 复杂度 |
|------|--------|------|--------|
| 4.1 | 系统夜间模式检测 | `Themes.java` | 中 |
| 4.2 | 广播安全注册 (API 33+) | `EditorView.java` | 低 |
| 4.3 | ViewBinding 替代 AndroidAnnotations | 多文件 | 高 |
